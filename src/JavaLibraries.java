...
public class JavaLibraries {
    ...
    public static void main(String[] args) {
        ...
        LocalDateTime anotherDateAndTime = LocalDateTime.of(2022, 11, 16, 17, 55);
        ...
        System.out.println(anotherDateAndTime);
        System.out.println(someDate);
        System.out.println(someTime);

        //'Instant' class includes timezone
        LocalDate yesterday = LocalDate.now().minusDays(1);
        LocalDate myBirthday = LocalDate.of(1998, 10, 13);
        Period difference = Period.between(myBirthday, yesterday);
        System.out.println("There are " + difference.getYears() + " years and " + difference.getMonths() + " months, and " + difference.getDays() + " days between the two dates.");
